...
const certifications = [
    { 
        ...
        issuer: 'Coursera',
        image: '/image/COURSERA DATA ANALYST CERTIFICATE .png'
    },
    { 
        title: 'AI Essentials', 
        issuer: 'Coursera',
        image: '/image/aI ESSENTIAL CERTIFICATE COURSERA .png'
    },
    { 
        title: 'Networking', 
        issuer: 'Cisco Academy',
        image: '/image/CISCO NETWROKING CERTIFICATE .png'
    },
    { 
        title: 'Webwizard LRN Certification', 
        issuer: 'LRN Certification',
        image: '/image/LRN CERTIFICATE WEB WIZARD.png'
    },
    { 
        title: 'SBTE WEB WIZARD CERTIFICATE'  ,
        issuer: 'SBTE Certification',
        image: '/image/SINDH BOARD WEB WIZRD CERTIFICATE .png'
    },
];

const CertificationCard = ({ title, issuer, index, image }) => (
    <motion.div 
        initial={{ opacity: 0, scale: 0.8 }}
        whileInView={{ opacity: 1, scale: 1 }}
        viewport={{ once: true }}
    ...
    >
        ...
        <div className="relative h-full flex flex-col items-center justify-center p-8 rounded-2xl bg-[#080808] border border-white/10 group-hover:border-yellow-500/50 shadow-2xl text-center transition-all duration-300 overflow-hidden">
            ...
            <div className="mb-4 w-full">
                {image ? (
                    <div className="w-full h-36 rounded-xl overflow-hidden border border-white/10 mb-4">
                        <img 
                            src={image} 
                            alt={title}
    ...
    return (
        <section id="certifications" className="relative py-32 px-6 bg-black text-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto text-center relative z-10">
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
                    {certifications.map((cert, i) => (
                        <CertificationCard key={i} index={i} title={cert.title} issuer={cert.issuer} image={cert.image} />
                    ))}
                </div>
